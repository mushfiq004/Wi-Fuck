#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Modify History : rofl0r => Biri_B@B@ => Mohammad_Alamin (Toxinum) => Shourov => Mushfiqur Rahman
# VERSION 1.0.1
  ...
  \ \ /\ / /| | |_  | |_____| |_| | / _ \| |   | ' /  
   \ V  V / | |  _| | |_____|  _  |/ ___ \ |___| . \  
    \_/\_/  |_|_|   |_|     |_| |_/_/   \_\____|_|\_\ 
                                                  \n\t\t[\033[1;32m*\033[1;37m] Modified by : Mushfiq\n\t\t[\033[1;32m*\033[1;37m] Version     : 69.0.0 \n\t\t[\033[1;32m*\033[1;37m] Telegram    : @mushibhaiii \n''')
